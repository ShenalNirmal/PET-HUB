    ...
    <div class="container mt-5 pt-5 pb-3">
      ...
      <div class="row">
        <div class="col-lg-3 col-md-6">
          ...
          >
            <img class="card-img-top" src="img\Breeds\d1.jpg" alt="" />
        ...
        <div class="col-lg-3 col-md-6">
          <div
            class="team card position-relative overflow-hidden border-0 mb-4"
          >
            <img class="card-img-top" src="img\Breeds\d2.webp" alt="" />
            <div class="card-body text-center p-0">
              <div
                class="team-text d-flex flex-column justify-content-center bg-light"
              >
        ...
        <div class="col-lg-3 col-md-6">
          <div
            class="team card position-relative overflow-hidden border-0 mb-4"
          >
            <img class="card-img-top" src="img\Breeds\d3.jpg" alt="" />
            <div class="card-body text-center p-0">
              <div
                class="team-text d-flex flex-column justify-content-center bg-light"
              >
        ...
        <div class="col-lg-3 col-md-6">
          <div
            class="team card position-relative overflow-hidden border-0 mb-4"
          >
            <img class="card-img-top" src="img\Breeds\d4.jpg" alt="" />
            <div class="card-body text-center p-0">
              <div
                class="team-text d-flex flex-column justify-content-center bg-light"
              >
