                     ...
                     <div class="card-body product-form">
                        ...
                        <form method="POST" enctype="multipart/form-data">
                           <div class="form-group w-50">
                              ...
                              <input type="text" name="name" class="form-control"  placeholder="Enter Breed Name">
                           </div>
                           ...
                           <div class="form-group w-50">
                              ...
                              <input type="text" name="category" class="form-control" placeholder="Enter Breed Category">
                           </div>
   ...
   if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST["submit"])) {
      ...
      if (in_array($imageFileType, $allowedExtensions)) {
         if (move_uploaded_file($_FILES["image"]["tmp_name"], $targetFile)) {
            ...
            $sql = "INSERT INTO breeds (breed_name, image_path, price, category) 
            VALUES ('$breedName', '$targetFile', '$price', '$category')";            
            if ($conn->query($sql) === TRUE) {
               echo '<script>
               Swal.fire({
                 title: "Successfull!",
                 text: "Breed added successful!",
                 icon: "success"
               });
             </script>';
            } else {
